...
//     .then((data) => {
//         // console.log(data)
//         console.log(`You are in : ${data[0].city},${data.country}`)
//         renderUi(data[0]);
//     })
//     .catch(err=>{
...
//     try{
//         const createImg = await createImage();
...
const loadAll = async function (imgArr) {
    try{
        const imgs = imgArr.map(async elem =>  await createImage(elem) )
        console.log(imgs)
    }
    catch(err){
        console.log(err.message);
